...
DEFAULT_OUTPUT = Path("analysis/png/homka_bgef_depth_grouped_speedup_table.png")
DEFAULT_CSV = Path("analysis/tables/homka_bgef_depth_grouped_speedup_table.csv")
