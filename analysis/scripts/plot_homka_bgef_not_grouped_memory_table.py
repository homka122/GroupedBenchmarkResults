...
DEFAULT_OUTPUT = Path("analysis/png/homka_bgef_depth_not_grouped_memory_table.png")
DEFAULT_CSV = Path("analysis/tables/homka_bgef_depth_not_grouped_memory_table.csv")
BENCH_ORDER = [
    "basic",
    "collections",
    "cornerCases",
