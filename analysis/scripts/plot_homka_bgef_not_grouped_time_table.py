...
RESULT_ROOT = Path("results/homka_bgef_depth_g0")
DEFAULT_OUTPUT = Path("analysis/png/homka_bgef_depth_not_grouped_time_table.png")
DEFAULT_CSV = Path("analysis/tables/homka_bgef_depth_not_grouped_time_table.csv")
BENCH_ORDER = [
    "basic",
    "collections",
    "cornerCases",
