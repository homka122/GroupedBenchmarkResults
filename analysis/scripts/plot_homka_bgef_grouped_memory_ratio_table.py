...
DEFAULT_OUTPUT = Path("analysis/png/homka_bgef_depth_grouped_memory_ratio_table.png")
DEFAULT_CSV = Path("analysis/tables/homka_bgef_depth_grouped_memory_ratio_table.csv")
BENCH_ORDER = [
    "basic",
    "collections",
    "cornerCases",
