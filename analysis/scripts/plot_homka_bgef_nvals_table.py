...
DEFAULT_ROOTS = {
    "G1 grouped": Path("results/homka_bgef_depth"),
    "G0 not grouped": Path("results/homka_bgef_depth_g0"),
}
DEFAULT_OUTPUT = Path("analysis/png/homka_bgef_depth_nvals_table.png")
DEFAULT_CSV = Path("analysis/tables/homka_bgef_depth_nvals_table.csv")
BENCH_ORDER = [
    "basic",
    "collections",
    "cornerCases",
