...
DEFAULT_TIME_OUTPUT = Path("analysis2/png/homka_bgef_depth_grouped_time_by_total_contexts.png")
DEFAULT_MEMORY_OUTPUT = Path("analysis2/png/homka_bgef_depth_grouped_memory_by_total_contexts.png")
DEFAULT_CSV = Path("analysis2/tables/homka_bgef_depth_grouped_time_memory_by_total_contexts.csv")
CONTEXTS = [1, 2, 3, 5, 10]
DEPTHS = [1, 2, 3, 4]
BENCH_ORDER = [
    "basic",
