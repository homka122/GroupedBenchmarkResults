...
GRAPH_SUMMARY = Path("analysis2/graphs/summary.md")
DEFAULT_OUTPUT = Path("analysis2/png/homka_bgef_depth_speedup_by_context_field_ratio.png")
DEFAULT_CSV = Path("analysis2/tables/homka_bgef_depth_speedup_by_context_field_ratio.csv")
